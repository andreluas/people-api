...
public class PeopleTestDTO implements Serializable {
    ...
    public PeopleTestDTO(Long id, @NotBlank(message = "field cannot be empty") String firstName,
    ...
    public PeopleTestDTO(People entity) {
        id = entity.getId();
